...
public class SellerController {
	...
	@PostMapping("/save")
	public ResponseEntity<BaseResponse> save(@RequestBody SellerDto request) {
		if (request != null) {
			ValidationCheck.hasValidate(request);
		}

		SellerDto dto = service.save(request);
	...
	public ResponseEntity<BaseResponse> get(@PathVariable("id") Long id) {
		...
		SellerDto dto = service.getById(id);
	...
	public ResponseEntity<BaseResponse> getByStoreId(@PathVariable("storeId") Long storeId) {
		...
		Set<SellerDto> list = service.getByStoreId(storeId);
		BaseResponse baseResponse = new BaseResponse();
